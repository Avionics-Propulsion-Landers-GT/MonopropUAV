...
ang_accel_BF = simplify(inv(inertia) * torque_net_body);

A4 = jacobian(ang_accel_BF, (full_state'));
B4 = jacobian(ang_accel_BF, (full_input'));
...
% Fl_WF = R_wf*(Fl);
% Fg = m*g';
accel_final_BF = (1/m)*(thrust + Fd);
% 3xf

A2 = jacobian((accel_final_BF'), (full_state'));
B2 = jacobian((accel_final_BF'), (full_input'));

...
//
// _coder_calculateB_api.cpp
//
// Code generation for function '_coder_calculateB_api'
//
...
static const mxArray *emlrt_marshallOut(real_T u[84]);
...
void calculateB_api(const mxArray *const prhs[12], const mxArray **plhs)
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
  ...
  B = (real_T(*)[84])mxMalloc(sizeof(real_T[84]));
  ...
  calculateB(&st, m, f, cDrag, areaVar, *in5, *in6, *in7, *in8, *in9, *in10,
             *in11, *in12, *B);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*B);
}

// End of code generation (_coder_calculateB_api.cpp)

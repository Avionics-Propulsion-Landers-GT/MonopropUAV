...
//
// _coder_calculateA_info.cpp
//
// Code generation for function 'calculateA'
//

// Include files
#include "_coder_calculateA_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "QualifiedName",
                emlrtMxCreateString("calculateA"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("C:\\Users\\Nathan Kim\\Documents\\MATLAB\\GTPL "
                          "TVC\\Algorithms\\DynamicsModel\\calculateA.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739687.8131944444));
...
// End of code generation (_coder_calculateA_info.cpp)

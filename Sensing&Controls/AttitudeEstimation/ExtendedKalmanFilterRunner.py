...
ekf = ExtendedKalmanFilter.ExtendedKalmanFilter(np.array([0,0,0]), np.zeros(9), 0.001, 0.45, 1 * 1000000, 100)
attitudes = []
...
with open('extended_kalman_filter_output.csv', 'w', newline='') as file:
...
measurements = pd.read_csv('extended_kalman_filter_output.csv', header=None)
